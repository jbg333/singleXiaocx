 ...
 * @since 2017-07-17
 */
public interface SSOConstants extends TokenConstants{	
	public final static String USER_ID = "uid";
	public final static String USER_NAME = "username";
	/*public final static String USER_TOKEN = "authToken";*/
    ...
    String SSO_TOKEN_ATTR = SSOConfig.getInstance().getAccessTokenName();
